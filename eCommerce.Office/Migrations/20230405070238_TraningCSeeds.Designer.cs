...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20230405070238_TraningCSeeds")]
    partial class TraningCSeeds
    {
            ...
            modelBuilder.Entity("eCommerce.Office.EmployeeSection", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SectionId = 1,
                            EmployeeId = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 4, 5, 4, 2, 38, 359, DateTimeKind.Unspecified).AddTicks(425), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SectionId = 1,
                            EmployeeId = 6,
                            Created = new DateTimeOffset(new DateTime(2023, 4, 5, 4, 2, 38, 359, DateTimeKind.Unspecified).AddTicks(453), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SectionId = 2,
                            EmployeeId = 5,
                            Created = new DateTimeOffset(new DateTime(2023, 4, 5, 4, 2, 38, 359, DateTimeKind.Unspecified).AddTicks(455), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SectionId = 2,
                            EmployeeId = 4,
                            Created = new DateTimeOffset(new DateTime(2023, 4, 5, 4, 2, 38, 359, DateTimeKind.Unspecified).AddTicks(456), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SectionId = 3,
                            EmployeeId = 2,
                            Created = new DateTimeOffset(new DateTime(2023, 4, 5, 4, 2, 38, 359, DateTimeKind.Unspecified).AddTicks(457), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SectionId = 4,
                            EmployeeId = 3,
                            Created = new DateTimeOffset(new DateTime(2023, 4, 5, 4, 2, 38, 359, DateTimeKind.Unspecified).AddTicks(459), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
